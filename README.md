...
基于 Unity（tuanjie1.9.3） 的《星际迷航》主题太空飞行模拟器。操作逻辑借鉴 Orbiter 2016 的牛顿力学飞行模型，采用六自由度惯性飞行系统，提供旋转 / 平移双模式操控、多武器战斗、银河曲速导航及舰桥室内视角等特性。
 致敬星际迷航tng ds9 voy
---
...
- 模型全部来自 Sketchfab，文件名前缀可追溯
- 个别模型存在一些问题导入会直接错误闪退，将模型导入blender再导出即可解决
